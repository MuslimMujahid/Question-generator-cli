...
from utils import read_text, tokenize, split_text, preprocess
...
data_path = './data'
dataset = 'movie_lines.txt'
preproc_data = 'movie_lines_preprocess.txt'


if __name__ == '__main__':
    preprocess(data_path, dataset, preproc_data)
    train_text, val_text = split_text(data_path, preproc_data)
    vocab = tokenize(train_text)
